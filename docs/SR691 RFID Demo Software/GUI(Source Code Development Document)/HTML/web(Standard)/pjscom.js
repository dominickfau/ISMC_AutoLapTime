...
function connect() {
    ...
    if (rAdax == null) {
        rAdax = document.getElementById("ADActiveXPCom");
    }

    host = document.getElementById("comport").options[document.getElementById("comport").selectedIndex].text;
    rateorport = parseInt(document.getElementById("baudrate").options[document.getElementById("baudrate").selectedIndex].text, 10);
...
function init() {
    rFCount = rAdax.jspSetConfig("1E 01 6E 54 5D 66 6F 78 82 03 0A 00 01 00 1E 0A 0F 01 10 01 01 02 00 02 00 00 00 20");
