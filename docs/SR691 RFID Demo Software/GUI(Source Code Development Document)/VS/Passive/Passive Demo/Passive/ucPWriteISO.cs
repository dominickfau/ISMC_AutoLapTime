...
namespace ADSDKDemo
{
    public partial class ucPWriteISO : UserControl
    {
        ...
        private void btnRead_Click(object sender, EventArgs e)
        {
            ...
            PassiveCommand.Read6B(SystemPub.ADRcp, start, len);
